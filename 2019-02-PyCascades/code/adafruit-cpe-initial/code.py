# TODO -- Add licensing, copyright, and instructions for using the Visual studio code extension
# This is forked version of the original demo optimized for the VS Code Circuit Playground Express add-in
# When the device is running use the command:
# "Device Simulator Express: Open Serial Monitor" in Visual Studio Code
# to get read outs from the device
